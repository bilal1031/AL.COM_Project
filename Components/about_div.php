<?php
    echo '<div class="d-flex flex-row justify-content-center mt-5">
                <div class="card" style="width: 45%;">
                    <div class="card-body">
                        ...
                        <p class="card-text">This software is designed and coded by <b>Bit Technologies Inc</b>
                                            ...
                                            <br>
                                            <br>For any future queries or techincal issues experienced by the user
                                            contact us...
                                            <br>
                        </p>
                        <h5>Contact Us:</h5>
                        <span><b>Phone:</b> 0320-6892358, 0314-4288146</span>
                    </div>
            </div>
            </div>';
